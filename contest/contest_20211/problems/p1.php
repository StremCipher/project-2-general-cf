...
<?php
    ...
    $login_btn="login";
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    $_SESSION["selected_question"]="_01";
    $question_number=1;
    if($_SESSION){
        if(isset($_SESSION["username"])){
            ...
            echo "<script>setTimeout(\"location.href = '/xampp_projects/general cf/login.php';\",1);</script>";
        }
    }
    else{
        echo "<script>alert('login to access this page')</script>";
...
<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="/xampp_projects/general cf/profile.php"><span class="glyphicon glyphicon-user"></span> <?php echo $username?></a></li>
				<li><a href="/xampp_projects/general cf/login_logout.php"><span class="glyphicon glyphicon-log-out"></span> <?php echo $login_btn?></a></li>
			</ul>
		</div>
	</nav>
  </div>
                    ...
                    <script>
                        ...
                        function save_response(form, name) {
                            ...
                            if(rgforcontest==0){
                                ...
                                // window.location.replace('/xampp_projects/general cf/all_contest.php');
                            }
                            else{
                                ...
                                for (var i=0, len=radios.length; i<len; i++) {
                                    ...
                                    xmlhttp.open("GET","/xampp_projects/general cf/update_answersheet.php?selected_option="+new_val,true);
                                    xmlhttp.send();
                                    return;
                                }
                            }
                        ...
                        function clear_response() {
                            ...
                            if(rgforcontest==0){
                                ...
                                xmlhttp.open("GET","/xampp_projects/general cf/update_answersheet.php?selected_option="+0,true);
                                xmlhttp.send();
                                return; 
                            }
                        }
        ...
        <div class="right" >
            <div class="answersheet" id="answersheet_div">
                <table>
                    ...
                    <tr>
                        <th><button id="_03"><a href="p3.php?contest_id=_20211">05</a></button></th>
                        <th><button id="_04"><a href="p4.php?contest_id=_20211">06</a></button></th>
...
<script>
    ...
    function mark_selected_option(option){
        if(option==1)
            $( "input[name='option'][value='option_1']" ).prop({checked: true});
        if(option==2)
            $( "input[name='option'][value='option_2']" ).prop({checked: true});
        if(option==3)
            $( "input[name='option'][value='option_3']" ).prop({checked: true});
        if(option==4)
            $( "input[name='option'][value='option_4']" ).prop({checked: true});
    }
</script>
<?php
    if(isset($_SESSION["username"])){
        ...
        if($user){
            ...
            // ***************************************** mark previosly selected option *********************************************************************
            $option=$user[$selected_question];
            echo("<script > mark_selected_option('$option')</script>");
        }
    }
?>
